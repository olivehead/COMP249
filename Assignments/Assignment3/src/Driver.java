...
public class Driver {
	...
	public static void main(String[] args) {
		...
		String sortedFileName = "Sorted_Book_Info.txt", binaryFileName = "Book.dat";
		...
		try {
			...
			// Binary search: **NullPointerException***??
			//BookInventory2.binaryBookSearch(BookInventory2.bkArr, 0, BookInventory2.bkArr.length, 800003243);
			
			//Write Book Objects to binary File:
			BookInventory2.writeBinaryFile(oos, binaryFileName);
